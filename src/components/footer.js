...
const footer = ({locale}) => {
  ...
  initTranslations(locale,['subscribe']).then(({ t }) => {
    setText1(t('Subscribe to get more info'))
    setText2(t("At LifeCom Radio, we believe in providing more than just music and podcasts; we're dedicated to fostering a vibrant community of learning and growth."))
    setText3(t('Email address'))
    setText4(t('Home'))
    setText5(t('Explore'))
    setText6(t('Schedule'))
    setText7(t('About us'))
  ...
  return (
    <div className='hidden md:block mt-[12rem] bg-[#09172E] w-full pt-[3rem]'>
      ...
      <Link href="/"><li className={`font-normal text-[16px] leading-[19px] cursor-pointer hover:text-[#145C9B] ${pathnamee==="/" || pathname.length===3
                  ? "text-[#145C9B]"
      ...
      <Link href="/schedule"><li className={`font-normal text-[16px] leading-[19px] cursor-pointer  hover:text-[#145C9B] ${pathnamee === "/schedule"
                  ? "text-[#145C9B]"
                  : "bg-transparent text-white "}`}>{text6}</li></Link>
      <Link href="/about"><li className={`font-normal text-[16px] leading-[19px] cursor-pointer  hover:text-[#145C9B] ${pathnamee === "/about"
                  ? "text-[#145C9B]"
                  : "bg-transparent text-white "}`}>{text7}</li></Link>
         <Link href="/get-in-touch"><li className={`font-normal text-[16px] leading-[19px] cursor-pointer  hover:text-[#145C9B] ${pathnamee === "/get-in-touch"
                  ? "text-[#145C9B]"

...
const download = async ({locale}) => {
  ...
  return (
    <div className='hidden md:flex flex-row w-[80vw] justify-between items-center mt-[14rem] mx-auto'>
    <div>
    ...
    <div className='w-[50%] h-[287px] bg-gradient-to-r from-[#00255F4D] to-[#38475E43] flex flex-row gap-[4rem] items-center justify-center rounded-[4px]'>
       ...
       <a href='https://play.google.com/store/apps/details?id=com.lifecomradio.station
